...
var thisImage = null;
var areTouchEventsCreated = false;
...
function initEvents() {
    if (!script.shouldDisableTouchEvents) {
        createTouchEvents();
    }
    return true;
}
...
function createTouchEvents() {
    ...
    areTouchEventsCreated = true;
}


// Called when Touch has started
function onTouchStart(eventData) {
    if (!interactable || script.shouldDisableTouchEvents || !sceneObject.enabled) {
        return;
    }
